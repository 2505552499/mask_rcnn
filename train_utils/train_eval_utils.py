...
def evaluate(model, data_loader, device):
    ...
    det_metric = EvalCOCOMetric(data_loader.dataset.coco, iou_type="bbox", results_file_name="result/det_results.json")
    seg_metric = EvalCOCOMetric(data_loader.dataset.coco, iou_type="segm", results_file_name="result/seg_results.json")
